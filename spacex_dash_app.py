...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig_data = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig_data['unit']=1
        fig = px.pie(fig_data, values='unit', 
        names='class', 
...
def get_scatter_plot(entered_site,payload_range):
    if entered_site == 'ALL':
        fig=px.scatter(data_frame=spacex_df, x='Payload Mass (kg)', y='class', color='Launch Site',
                        range_x=payload_range, 
                        title='Correlation between Payload and Success for all sites')
    else:
        fig_data = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig=px.scatter(data_frame=fig_data, x='Payload Mass (kg)', y='class',
                        range_x=payload_range,
